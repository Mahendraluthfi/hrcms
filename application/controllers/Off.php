...
public function __construct()
	...
	{
		$data['joined_values'] = $this->LeaveModel->getAllData('2');		
		$data['content'] = 'off';
	...
	public function leave_approval($id)
	{
		...
		$this->db->query("UPDATE employees SET employee_off_rem = employee_off_rem - '$ld' WHERE employee_id='$id_e'");		
...
/* End of file Off.php */
/* Location: ./application/controllers/Off.php */