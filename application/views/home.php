            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Employess</h5>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Employess</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Charts</h5>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Charts</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Widgets </h5>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Widgets</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Performance</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            ...
            <div class="comment-widgets scrollable">
              <div class="d-flex flex-row comment-row">
                <div class="p-2"><img src="<?php echo base_url() ?>asset/extra/assets/img/icons/users/3.jpg" alt="user" width="75px" height="75px" class="rounded-circle"></div>
              ...
              <div class="d-flex flex-row comment-row">
                ...
                <div class="comment-text w-100">
                  ...
                  <span class="m-b-20 d-block">Lorem Ipsum is simply dummy text of the printing and type setting
                    industry. </span>
                  <div class="comment-footer">
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2019 <a href="https://tri-niche.com" class="font-weight-bold ml-1" target="_blank">Tri-Niche Pte
                Ltd</a>
            </div>
          </div>
        </div>
