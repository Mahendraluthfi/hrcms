            ...
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                   <button type="button" class="btn btn-success" onclick="add()">Request New Off</button>
                </div>
              </div>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Request New Off</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body form">
                <?php echo form_open_multipart('off_emp/save', array('class' => 'form-horizontal', 'id' => 'form')); ?>
...
<script>
    ...
    function add()
    {
     ...
     function v_leave(id){                
        $.ajax({
        url : "<?php echo site_url('index.php/off_emp/get')?>/" + id,
        type: "GET",
        dataType: "JSON",
     ...
     function save(){
        var url;            
        url = "<?php echo site_url('index.php/off_emp/save')?>";                
    ...
    function cancel(id) {        
        $("#link").attr("href","<?php echo base_url('off_emp/cancel/') ?>"+id);
