          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-12">
                  <h3 class="mb-0">Sick Management</h3>
                </div>                
              </div>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('sick/leave_rejected'); ?>" method="post">
...
<script>
     function view(id) {
        $.ajax({
        url : "<?php echo site_url('index.php/sick/get')?>/" + id,
        type: "GET",
        dataType: "JSON",
        ...
        {   
            ...
            if (data.leave_status == "PENDING") {                
                ...
                var approveButton = '<a href="<?php echo base_url()?>sick/leave_approval/'+id+'" class="btn btn-success" onclick="return confirm(\'Are you sure?\')">Approve</a>';
