            ...
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                   <button type="button" class="btn btn-success" onclick="add()">Request New Leave</button>
                </div>
              </div>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <?php echo form_open_multipart('leave_emp/save', array('class' => 'form-horizontal', 'id' => 'form')); ?>
...
<script>
    ...
    function add()
    {
     ...
     function v_leave(id){                
        $.ajax({
        url : "<?php echo site_url('index.php/leave_emp/get')?>/" + id,
        type: "GET",
        dataType: "JSON",
     ...
     function save(){
        var url;            
        url = "<?php echo site_url('index.php/leave_emp/save')?>";                
    ...
    function cancel(id) {        
        $("#link").attr("href","<?php echo base_url('leave_emp/cancel/') ?>"+id);
