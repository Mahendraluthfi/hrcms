<div class="header bg-gradient-success pb-5 pt-5 pt-md-8">
 ...
 <div class="container-fluid mt--6">
    ...
    <script>              
      ...
      function tampil(){    
        $.ajax({
            url : "<?php echo site_url('index.php/salary_part/get')?>/",
            type: "GET",
            dataType: "JSON",
        ...
        $.ajax({            
            url : "<?php echo site_url('index.php/salary_part/get_allowance')?>",
            type: "GET",
            dataType: "JSON",
            success: function(data){
  ...
  $('#btn_simpan').on('click',function(){            
          ...
          $.ajax({
          type : "POST",
          url  : "<?php echo base_url('index.php/salary_part/add_allowance')?>",
          dataType : "JSON",
   ...
   $('#show_data').on('click','.item_hapus',function(){
            ...
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('index.php/salary_part/delete')?>",
            dataType : "JSON",
                    data : {id: id},
                    success: function(data){                        
                        tampil();
  ...
  $('.submit-salary').on('click', function(){
      ...
      if(conf == true){
        $.ajax({
          type : "POST",
          url  : "<?php echo base_url('index.php/salary_part/submit_salary')?>",
          dataType : "JSON",
          data : {salary:salary , ld:ld, ad:ad, ta:ta, ts:ts},
          success: function(data)
          {                     
              window.location = '<?php echo base_url('salary_part') ?>';
          },
          error: function (jqXHR, textStatus, errorThrown)
          {
              alert('Error adding / update data');
