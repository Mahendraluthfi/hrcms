...
<script>
	 function view(id) {
        $.ajax({
        url : "<?php echo site_url('index.php/leave/get')?>/" + id,
        type: "GET",
        dataType: "JSON",
        ...
        {   
            ...
            if (data.leave_status == "PENDING") {                
                ...
                var approveButton = '<a href="<?php echo base_url()?>leave/leave_approval/'+id+'" class="btn btn-success" onclick="return confirm(\'Are you sure?\')">Approve</a>';
