	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<?php echo form_open('login/submit', array('class'=> 'login100-form validate-form submit', 'style' => 'display:none;')); ?>
				...
				<?php echo form_open('login/submit', array('class'=> 'login100-form validate-form choose')); ?>
					<span class="login100-form-title">
						HRCMS Login
					</span>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn employer">
							Employer Login
						</button>						
					</div>
					<div class="container-login100-form-btn">
						<button class="login100-form-btn employee">
							Employee Login
						</button>						
					</div>
				</form>
